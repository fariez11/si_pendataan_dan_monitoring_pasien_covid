<?php 
    ...
    $ka1a= DB::SELECT("SELECT count(*)as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Suspek' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");
    $ka1b= DB::SELECT("SELECT count(*)as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Kasus Probabel' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");
    $ka1c= DB::SELECT("SELECT count(*)as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Suspek' AND ST_PASIEN = 'Isolasi' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");
    $ka1d= DB::SELECT("SELECT count(*)as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Suspek' AND ST_PASIEN = 'Discarder' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");


    $ka2a= DB::SELECT("SELECT count(*)as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Kasus Konfirmasi' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");
    $ka2b= DB::SELECT("SELECT count(*)as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Kasus Konfirmasi' AND b.STATUS = 'Terkena Gejala' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");
    $ka2c= DB::SELECT("SELECT count(*)as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Kasus Konfirmasi' AND b.STATUS = 'Tanpa Gejala' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");
    $ka2d= DB::SELECT("SELECT COUNT( DISTINCT a.NIK) as jum FROM pasien a, klinis b, r_perj1 c WHERE a.NIK = b.NIK AND b.NIK = c.NIK AND a.KAT = 'Kasus Konfirmasi' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");


    $ka2g= DB::SELECT("SELECT COUNT( DISTINCT a.NIK) as jum FROM pasien a, klinis b, r_perj1 c WHERE a.NIK = b.NIK AND b.NIK = c.NIK AND a.KAT = 'Kasus Konfirmasi' AND b.ST_PASIEN = 'Sembuh' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");



    $ka3f= DB::SELECT("SELECT count(*)as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Kontak Erat' AND ST_PASIEN = 'Discarder' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");


    $ka4b= DB::SELECT("SELECT COUNT(DISTINCT a.NIK) as jum FROM pasien a, klinis b WHERE a.NIK = b.NIK AND a.KAT = 'Kasus Probabel' AND b.ST_PASIEN = 'Meninggal' AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");



    $ka5a= DB::SELECT("SELECT COUNT(DISTINCT a.NIK) as jum FROM pasien a, klinis b, p_penunjang c WHERE a.NIK = b.NIK AND a.NIK = c.NIK AND MONTH(b.TGL_RELEASE) = '$bln' AND YEAR(b.TGL_RELEASE) = '$thn' ");
