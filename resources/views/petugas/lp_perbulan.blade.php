  ...
  <ul class="sidebar-menu">
    ...
    <li class="dropdown active">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active"><a class="nav-link" href="#">per Bulan</a></li>
      </ul>
    </li>
  </ul>
@endsection
    ...
    <section class="section">
        ...
        <div class="col-12">
            ...
            <div class="card-header">
              <h4>Laporan berdasarkan Bulan </h4>
            </div>
            <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6" style="border-right: solid 1px lightgrey;">
                    ...
                    <form action="/datalaporanperbulan">
                ...
                <div class="col-md-6">
                    ...
                    <form action="/cetaklaporanperbulan">
                        <table style="width:100%;">
                            <tr>
                                <td>
                                    <label for="password-vertical">bulan</label>
            ...
            <div class="table-responsive">
                <table border="" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">@foreach($ka2f as $ka2f) {{$ka2f->jum}} orang @endforeach</td>
                    </tr>
                    <tr>
                        <td></td>
