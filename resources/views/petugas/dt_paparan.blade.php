  ...
  <ul class="sidebar-menu">
    ...
    <li class="menu-header">Data</li>
        ...
        <li class="dropdown active">
          <a href="#" class="nav-link"><i data-feather="check-circle"></i><span>Data Faktor Kontak / Paparan</span></a>
        </li>
...
@section('content')
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="#" class="btn btn-icon icon-left btn-primary" data-toggle="modal" data-target="#exampleModalCenter"  style="margin: -30px 0px 10px 0px;"><i class="fas fa-plus-square"></i> Tambah Data Paparan</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 150px;">
                                <a href="/ppr:det={{$dat->NIK}}" class="btn btn-info"><i class="fa fa-info-circle"></i></a>
                                <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#editPaparan{{$dat->NIK}}"><i class="fa fa-edit"></i></a>
                                <a href="/ppr:del={{$dat->NIK}}" class="btn btn-danger" onclick="return(confirm('Anda Yakin ?'));"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
  ...
  @foreach($data as $ed)
  <div class="modal fade" id="editPaparan{{$ed->NIK}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
